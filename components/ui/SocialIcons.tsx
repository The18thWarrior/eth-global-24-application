...
export default function SocialIcons({ discordUrl, emailUrl, twitterUrl, githubUrl, instagramUrl, governanceUrl, websiteUrl, gitbookUrl }: { discordUrl?: string, emailUrl?: string, twitterUrl?: string, githubUrl?: string, instagramUrl?: string, governanceUrl?: string, websiteUrl?: string, gitbookUrl?: string }) {
  return (
    <>
